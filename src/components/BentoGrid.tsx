                ...
                {items.map((item, index) => {
                    ...
                    if (item.id === 2) {
                        ...
                        return (
                            ...
                            >
                                {/* MOBILE LAYOUT: Spread like cards but smaller */}
                                <div className="absolute inset-0 flex md:hidden items-center justify-center p-2 overflow-visible">
                                    <div className="relative w-full h-full flex items-center justify-center">
                                        {techStackImages.map((img, i) => {
                                            const xOffset = (i - 4) * 32; // Increased spread for mobile

                                            return (
                                                <motion.div
                                                    key={i}
                                                    className="absolute w-[44px] h-[44px] rounded-full shadow-lg overflow-hidden bg-white/80 backdrop-blur-sm border border-white/20 cursor-pointer"
                                                    style={{
                                                        x: xOffset,
                                                        zIndex: i + 1,
                                                    }}
